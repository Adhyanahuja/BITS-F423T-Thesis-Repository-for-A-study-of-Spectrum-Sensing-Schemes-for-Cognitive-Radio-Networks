%Double Threshold approach using Conventional Energy Detection (CED) model
%Part1: Single Eveent Energy Detection
...
legend('CED','Double Threshold Approach');
title('Double Threshold Approach Detection Probability Plot (BPSK)')
figure
...
legend('CED','Double Threshold Approach');
title('Double Threshold Approach Error Probability Plot (BPSK)')